...
<div class="ss1">
<form action ="find2.php" method="POST" align="center">
<input type="TEXT" name="search" placeholder="Please give here doctor speciality" required/></br>
<input type="TEXT" name="searchqq" placeholder="Please give here city name" required/></br>
...
$searchqi = $_POST['searchqq'];



//$searchq = preg_replace("#[^0-9a-z]#i","",$searchq);
//$searchqi = preg_replace("#[^0-9a-z]#i","",$searchqi);
//$query = mysqli_query($con,"SELECT * FROM doctor WHERE name LIKE '%$searchq%'") or die(mysqli_error($con));
$query = "SELECT * FROM doctor WHERE spe LIKE '%$searchq%' and address LIKE '%$searchqi%'";
...
//max-width= max-height= align=center accept=gif,image/png,png,image/jpg,image/jpeg
   ...
   echo "</td>"; 
    ...
    echo "<p id='qq'>No search results</p>";
 }/*
