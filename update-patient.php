...
$sql = "SELECT * FROM patient where id=$did";
...
$sql = "SELECT name FROM patient WHERE name='$n'";
$result = mysqli_query($conn, $sql);
...
exit();
	...
	$sql = "UPDATE patient SET name='$n' , pass='$nn' , address='$a', phone='$p', doctor='$pp', date='$s', time='$t' WHERE did='$did'";
...
<input type="text" name="doc" placeholder="New Doctor name" value="<?php echo $doc ?>"><br>
<input type="date" name="date" placeholder="New date" value="<?php echo $date ?>"><br>
<!--<input type="time" name="time" placeholder="Timing"><br>-->
<input type="time" name="time" placeholder="New Timing" value="<?php echo $time ?>">
